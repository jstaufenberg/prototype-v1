...
export default function PerformanceView({ patients, actionStatusById, blockerStatusById }: PerformanceViewProps) {
  const cmMetrics: MetricCard[] = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        trendDirection: 'neutral' as const,
        description: 'How much work agents are doing on your behalf',
        dataLabel: 'Computed' as const
      },
      {
  ...
  }, [patients, actionStatusById, blockerStatusById]);

  const deptMetrics: MetricCard[] = useMemo(() => {
    const totalActions = patients.reduce((sum, p) => sum + p.proposed_actions.items.length, 0);
  ...
  return (
    <section className="view-single-pane">
      <div className="perf-section">
        ...
        <p className="subtle">Operational metrics for your caseload.</p>
      ...
      <div className="perf-section">
        ...
        <p className="subtle">Organizational metrics for executive reporting.</p>
        <div className="perf-grid">
